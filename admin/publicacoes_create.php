...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO publicacoes (titulo, conteudo, status, link, imagem, admin_codigo)
            VALUES (?, ?, ?, ?, ?, ?)";
    
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('ssssss', $titulo, $conteudo, $status, $link, $imagem, $admin_codigo);
    ...
    if ($stmt->execute()) {
        ...
        echo "Erro ao salvar publicação: " . $conn->error;
    }
...
<body>
    <div class="container">
        ...
        <form method="POST" action="" class="form-publicacao">
            ...
            <a href="publicacoes_listar.php" class="back-btn">
